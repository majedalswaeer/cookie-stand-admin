function CreateForm(props) {
    return (
      <form class=" pt-6 mt-8 bg-green-300 mb-40 bg-green-300 rounded-3xl" onSubmit={props.data}>
        <div class="grid pb-100   gap-4 grid-rows-3">
          ...
          <div class=" flex-2 m-1 pb-10 ">
            ...
            <input type="text" class=" w-full form-control  " name="location" required />
          </div>
          <div class="grid  gap-6 grid-cols-4 mb-5">
            <div class="grid  gap-2 grid-rows-2 m-3 ">
              ...
              <input type="number" min="0" class="form-control" name='minCust' required />
            </div>
            <div class="grid  gap-2 grid-rows-2 m-3">
              <lable class="font-semibold" > Maximum Customers per Hour</lable>
              <input type="number" min="0" class="form-control" name="maxCust" required/>
            </div>
            <div class="grid  gap-2 grid-rows-2 m-3">
              <lable class="font-semibold"> Average Cookies per Sale</lable>
              <input type="number" min="0" class="form-control" name="avg" required />
            </div>
